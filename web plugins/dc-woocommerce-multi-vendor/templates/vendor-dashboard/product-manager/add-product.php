...
<div class="col-md-12">
    <form id="product_manager_form" class="woocommerce form-horizontal">
        ...
        ?>
        <div class="frontend_product_manager_product_types" style="display:none">
            <?php
            $product_types = array();
            if (is_user_wcmp_vendor($current_user_id)) {
            ...
            if (!empty($product_types)) {
                if (!$product_id) {
                    $WCMp->wcmp_frontend_fields->wcmp_generate_form_field(array("product_type" => array('label' => __('', 'dc-woocommerce-multi-vendor'), 'type' => 'select', 'attributes' => $custom_product_type_attribute)));
                    if (is_user_wcmp_vendor($current_user_id)) {
        ...
        <?php } ?>
                ...
                $vendor_show_sku = (apply_filters( 'wcmp_vendor_product_sku_enabled', false , get_current_vendor_id() )) ? 'text' : 'hidden';
                $WCMp->wcmp_frontend_fields->wcmp_generate_form_field(apply_filters('wcmp_fpm_fields_general', array("title" => array('label' => __('Product Name', 'dc-woocommerce-multi-vendor'), 'type' => 'text', 'class' => 'regular-text pro_ele simple variable external grouped', 'label_class' => 'pro_title pro_ele simple variable external grouped', 'value' => $title),
                    ...
                    "regular_price" => array('label' => __('Price ', 'dc-woocommerce-multi-vendor') . '(' . get_woocommerce_currency_symbol() . ')', 'type' => 'number', 'attributes' => array( 'min'=>2 ), 'wrapper_class' =>'pro_ele simple external non-grouped non-booking non-accommodation-booking non-subscription non-variable non-variable-subscription non-redq_rental non-auction','class' => 'regular-text simple external non-grouped non-booking non-accommodation-booking non-subscription non-variable non-variable-subscription non-redq_rental non-auction', 'label_class' => 'pro_ele pro_title simple external non-grouped non-booking non-accommodation-booking non-subscription non-variable non-variable-subscription non-redq_rental non-auction', 'value' => $regular_price),
                    "sale_price" => array('label' => __('Discount Selling Price ', 'dc-woocommerce-multi-vendor') . '(' . get_woocommerce_currency_symbol() . ')', 'type' => 'number', 'attributes' => array( 'min'=>2 ), 'wrapper_class' =>'pro_ele simple external non-grouped non-booking non-accommodation-booking non-variable non-variable-subscription non-redq_rental non-auction','class' => 'regular-text simple external non-grouped non-booking non-accommodation-booking non-variable non-variable-subscription non-redq_rental non-auction', 'label_class' => 'pro_ele pro_title simple external non-grouped non-booking non-accommodation-booking non-variable non-variable-subscription non-redq_rental non-auction', 'value' => $sale_price),
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9">
                        <select id="product_cats" name="product_cats[]" class="form-control regular-select pro_ele_head simple variable external grouped"  style="width: 100%;">
                            ...
                            if ($product_taxonomy->public && $product_taxonomy->show_ui && $product_taxonomy->meta_box_cb) {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-9">
                                        ...
                                        <select id="<?php echo $product_taxonomy->name; ?>" name="product_custom_taxonomies[<?php echo $product_taxonomy->name; ?>][]" class="form-control regular-select product_taxonomies pro_ele simple variable external grouped"  style="width: 100%;">
                                            <option value="" disabled selected hidden></option>
                                            <?php
...
//                ));
            ...
            <?php } ?>
             ...
             <h3 class="pro_ele_head simple variable grouped non-external non-redq_rental non-accommodation-booking non-booking <?php if (apply_filters("vendor_product_inventory_hide",false)) echo ' vendor_hidden'; ?>"><?php _e('Stock Management', 'dc-woocommerce-multi-vendor'); ?></h3>
            ...
            <h3 class="pro_ele_head simple variable external grouped"><?php _e('Image and Gallery', 'dc-woocommerce-multi-vendor'); ?></h3>
            <div class="pro_ele_block simple variable external grouped">

                <?php
                $WCMp->wcmp_frontend_fields->wcmp_generate_form_field(apply_filters('wcmp_fpm_fields_featured_images', array("featured_img" => array('label' => __('Main Image', 'dc-woocommerce-multi-vendor'), 'type' => 'upload', 'class' => 'regular-text pro_ele simple variable external grouped', 'label_class' => 'pro_title', 'value' => $featured_img),
                    "gallery_img" => array('label' => __('Additional Images', 'dc-woocommerce-multi-vendor'), 'type' => 'multiinput', 'class' => 'regular-text pro_ele simple variable external grouped', 'label_class' => 'pro_title', 'value' => $gallery_img_urls, 'options' => array(
