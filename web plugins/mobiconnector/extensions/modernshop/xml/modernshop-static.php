...
function modernshop_get_static(){
    $statics = array(
        array(
            'label' => 'Title Buyer Product',
            'type' => 'text',
            'id' => 'modern-buyer-product-title',
            'className' => 'i18n-multilingual mordernshop modern-buyer-product-title',
            'name' => 'modern-buyer-product-title',
            'placeholder' => 'Modern Buyer Product Title',
            'defaultValue' => 'Buyer Protection',
            'notice' => ''
        ),
        array(
            'label' => 'Description Buyer Product',
            'type' => 'editor',
            'id' => 'modern-description-buyer-product',
            'className' => 'i18n-multilingual mordernshop modern-editor modern-description-buyer-product',
            'name' => 'modern-description-buyer-product',
            'placeholder' => 'Modern Description Buyer Product',
            'defaultValue' => 'Returns accepted if product not as described, seller pays return shipping; or kepp the product and agree refund with seller.',
            'notice' => ''
        ),
        array(
            'label' => 'Title Terms of use',
            'type' => 'text',
            'id' => 'modern-terms-ofuser-title',
            'className' => 'mordernshop modern-terms-ofuse-title',
            'name' => 'modern-terms-ofuser-title',
            'placeholder' => 'Modern Terms of use',
        ...
        array(
            ...
            'type' => 'editor',
            'id' => 'modern-description-term-ofuse',
            'className' => 'mordernshop modern-editor modern-description-term-ofuse',
            'name' => 'modern-description-term-ofuse',
            'placeholder' => 'Modern Description Terms of use',
        ...
        array(
            ...
            'type' => 'text',
            'id' => 'modern-privacy-policy-title',
            'className' => 'mordernshop modern-editor modern-privacy-policy-title',
            'name' => 'modern-privacy-policy-title',
            'placeholder' => 'Modern Title Privacy policy',
        ...
        array(
            ...
            'type' => 'editor',
            'id' => 'modern-description-privacy-policy',
            'className' => 'modernshop-editor modern-description-privacy-policy',
            'name' => 'modern-description-privacy-policy',
            'placeholder' => 'Cell Store Description Terms of use',
        ...
        array(
            ...
            'type' => 'text',
            'id' => 'modern-privacy-about-us',
            'className' => 'mordernshop modern-about-us-title',
            'name' => 'modern-privacy-about-us',
            'placeholder' => 'Modern About us',
        ...
        array(
            ...
            <p>We knows how important prom night is for you and that is why we strive to maintain our motto of never selling the same dress in the same color to the same event.</p>',
            'notice' => ''
        ),
        array(
            'label' => 'Title Can review order',
            'type' => 'text',
            'id' => 'modern-canreview-order-title',
            'className' => 'mordernshop modern-canreview-order-title',
            'name' => 'modern-canreview-order-title',
            'placeholder' => 'Modern Can review order',
            'defaultValue' => 'You can review your order',
            'notice' => ''
        ),
        array(
            'label' => 'Title Home page block 1',
            'type' => 'text',
            'id' => 'modern-homepage-title-1',
            'className' => 'mordernshop modern-homepage-title',
            'name' => 'modern-homepage-title-1',
            'placeholder' => 'Modern page block',
            'defaultValue' => '7 Day Free Returns',
            'notice' => ''
        ),
        array(
            'label' => 'Description Homepage block 1',
            'type' => 'textarea',
            'id' => 'modern-description-homepage-1',
            'className' => 'mordernshop modern-editor modern-description-homepage',
            'name' => 'modern-description-homepage-1',
            'placeholder' => 'Modern Description Homepage block',
            'defaultValue' => 'Return any products in 7 days',
            'notice' => ''
        ),
        array(
            'label' => 'Title Home page block 2',
            'type' => 'text',
            'id' => 'modern-homepage-title-2',
            'className' => 'mordernshop modern-homepage-title',
            'name' => 'modern-homepage-title-2',
            'placeholder' => 'Modern page block',
            'defaultValue' => '100% Certified',
            'notice' => ''
        ),
        array(
            'label' => 'Description Homepage block 2',
            'type' => 'textarea',
            'id' => 'modern-description-homepage-2',
            'className' => 'mordernshop modern-editor modern-description-homepage',
            'name' => 'modern-description-homepage-2',
            'placeholder' => 'Modern Description Homepage block',
            'defaultValue' => '100% certified organic cotton',
            'notice' => ''
        ),
        array(
            'label' => 'Title Home page block 3',
            'type' => 'text',
            'id' => 'modern-homepage-title-3',
            'className' => 'mordernshop modern-homepage-title',
            'name' => 'modern-homepage-title-3',
            'placeholder' => 'Modern page block',
            'defaultValue' => 'Life time Exchange',
            'notice' => ''
        ),
        array(
            'label' => 'Description Homepage block 3',
            'type' => 'textarea',
            'id' => 'modern-description-homepage-3',
            'className' => 'mordernshop modern-editor modern-description-homepage',
            'name' => 'modern-description-homepage-3',
            'placeholder' => 'Modern Description Homepage block',
            'defaultValue' => 'Anytime on any of our stores',
            'notice' => ''
        ),
        array(
            'label' => 'Title Home page block 4',
            'type' => 'text',
            'id' => 'modern-homepage-title-4',
            'className' => 'mordernshop modern-homepage-title',
            'name' => 'modern-homepage-title-4',
            'placeholder' => 'Modern page block',
            'defaultValue' => 'Support 24/24',
            'notice' => ''
        ),
        array(
            'label' => 'Description Homepage block 4',
            'type' => 'textarea',
            'id' => 'modern-description-homepage-4',
            'className' => 'mordernshop modern-editor modern-description-homepage',
            'name' => 'modern-description-homepage-4',
            'placeholder' => 'Modern Description Homepage block',
            'defaultValue' => 'Support hours to 24 hours a day, 7 days a week',
            'notice' => ''
        ),
        array(
            'label' => 'Title Footer Details',
            'type' => 'text',
            'id' => 'modern-footer-details-title',
            'className' => 'mordernshop modern-footer-details-title',
            'name' => 'modern-footer-details-title',
            'placeholder' => 'Modern Footer Details',
            'defaultValue' => 'WELCOME TO MODERNSHOP',
            'notice' => ''
        ),
        array(
            'label' => 'Footer Details Address',
            'type' => 'text',
            'id' => 'modern-footer-address',
            'className' => 'mordernshop modern-footer-address',
            'name' => 'modern-footer-address',
            'placeholder' => 'Modern Footer Details Address',
            'defaultValue' => 'Mo Lao – Ha Dong – Ha Noi –  Viet Nam',
            'notice' => ''
        ),
        array(
            'label' => 'Footer Details Phone',
            'type' => 'text',
            'id' => 'modern-footer-phone',
            'className' => 'mordernshop modern-footer-phone',
            'name' => 'modern-footer-phone',
            'placeholder' => 'Modern Footer Details Phone',
            'defaultValue' => '+30 123 456789  -  +44 987 654321',
            'notice' => ""
        ),
        array(
            'label' => 'Footer Details Email Domain',
            'type' => 'text',
            'id' => 'modern-footer-email-domain',
            'className' => 'mordernshop modern-footer-email-domain',
            'name' => 'modern-footer-email-domain',
            'placeholder' => 'Modern Footer Details Email Domain',
            'defaultValue' => 'info@modernshop.com  -  www.modernshop.com',
            'notice' => ""
        ),
        array(
            'label' => 'Link App on Google Play',
            'type' => 'text',
            'id' => 'modern-share-rate-android',
            'className' => 'mordernshop modern-share-rate-android',
            'name' => 'modern-share-rate-android',
            'placeholder' => 'https://play.google.com/store/apps/details?id=xxx.xxx.xxxxxxxxx',
            'defaultValue' => '',
            'notice' => "The Rated Link when an user click Rate button from your mobile application on Android"
        ),
        array(
            'label' => 'Link App on Itunes Store',
            'type' => 'text',
            'id' => 'modern-share-rate-ios',
            'className' => 'mordernshop modern-share-rate-ios',
            'name' => 'modern-share-rate-ios',
            'placeholder' => 'https://itunes.apple.com/us/app/modern-shop/xxxxxxxxxxxxxxxx',
            'defaultValue' => '',
            'notice' => "The Rated Link when an user click Rate button from your mobile application on iOS's devices (iPhone, iPad)"
        ),
        array(
            'label' => 'After Order Success Thanks',
            'type' => 'text',
            'id' => 'modern-order-success',
            'className' => 'mordernshop modern-order-success',
            'name' => 'modern-order-success-thanks',
            'placeholder' => 'Modern Order Success Thanks',
            'defaultValue' => 'Thanks For Shopping With Us',
            'notice' => ""
        ),
        array(
            'label' => 'Title Shipping Details Products',
            'type' => 'text',
            'id' => 'modern-title-shipping-details-product',
            'className' => 'mordernshop modern-title-shipping-details-product',
            'name' => 'modern-title-shipping-details-products',
            'placeholder' => 'Modern Title Shipping Details Products',
            'defaultValue' => 'Free',
            'notice' => ""
        ),
        array(
            'label' => 'Content Shipping Details Products',
            'type' => 'text',
            'id' => 'modern-title-shipping-details-product',
            'className' => 'mordernshop modern-title-shipping-details-product',
            'name' => 'modern-title-shipping-details-products',
        ...
        array(
            'label' => 'Content Shipping Details Products',
            'type' => 'text',
            'id' => 'modern-content-shipping-details-product',
            'className' => 'mordernshop modern-content-shipping-details-product',
            'name' => 'modern-content-shipping-details-products',
            'placeholder' => 'Modern Content Shipping Details Products',
            'defaultValue' => 'Shipping',
            'notice' => ""
        ),
        array(
            'label' => 'Title Delivery Details Products',
            'type' => 'text',
            'id' => 'modern-title-delivery-details-product',
            'className' => 'mordernshop modern-title-delivery-details-product',
            'name' => 'modern-title-delivery-details-products',
            'placeholder' => 'Modern Title Delivery Details Products',
            'defaultValue' => '16 Jan-17 Feb',
            'notice' => ""
        ),
        array(
            'label' => 'Content Delivery Details Products',
            'type' => 'text',
            'id' => 'modern-content-delivery-details-product',
            'className' => 'mordernshop modern-content-delivery-details-product',
            'name' => 'modern-content-delivery-details-products',
            'placeholder' => 'Modern Content Delivery Details Products',
            'defaultValue' => 'Est. Delivery',
            'notice' => ""
        ),
        array(
            'label' => 'Facebook Link in Footer',
            'type' => 'text',
            'id' => 'modern-link-facebook',
            'className' => 'mordernshop modern-link-facebook',
            'name' => 'modern-link-facebook',
            'placeholder' => 'https://www.facebook.com/',
            'defaultValue' => '',
            'notice' => ""
        ),
        array(
            'label' => 'Google+ Link in Footer',
            'type' => 'text',
            'id' => 'modern-link-google',
            'className' => 'mordernshop modern-link-google',
            'name' => 'modern-link-google',
            'placeholder' => 'https://plus.google.com',
            'defaultValue' => '',
            'notice' => ""
        ),
        array(
            'label' => 'Twitter Link in Footer',
            'type' => 'text',
            'id' => 'modern-link-twitter',
            'className' => 'mordernshop modern-link-twitter',
            'name' => 'modern-link-twitter',
